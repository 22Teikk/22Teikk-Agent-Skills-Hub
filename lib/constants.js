...
const GLOBAL_DIR = path.join(os.homedir(), '.teikk-agents-skills');
 ...
 * (SPEC, tasks, spec/, maestro flows, hook caches) so nothing is scattered
 * across the repo and one ignore line covers it all.
 */
